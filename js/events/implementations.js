...
class Implementations {
	...
	static got_it_button_click() {
		_selectors.loader_spinny
			.addClass(_classes.remove)
	}
	static play_button_click(){
		$(this).addClass(_classes.disabled)
			.siblings().removeClass(_classes.disabled);
	}
	static pause_button_click(){
		$(this).addClass(_classes.disabled)
			.prev().removeClass(_classes.disabled);
	}
	static stop_button_click(){
		$(this).add(this.previousElementSibling)
			.addClass(_classes.disabled).prev(_selectors_string.play_button)
